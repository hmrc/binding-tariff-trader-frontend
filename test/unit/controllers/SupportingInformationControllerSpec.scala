...
class SupportingInformationControllerSpec extends ControllerSpecBase {
  ...
  private def controller(dataRetrievalAction: DataRetrievalAction = getEmptyCacheMap) =
    new SupportingInformationController(
      frontendAppConfig,
  ...
  private def viewAsString(form: Form[_] = form) = supportingInformation(frontendAppConfig, form, NormalMode)(fakeRequest, messages).toString
