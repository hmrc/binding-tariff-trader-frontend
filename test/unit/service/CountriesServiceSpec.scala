...
class CountriesServiceSpec extends UnitSpec with MockitoSugar with GuiceOneAppPerSuite {
  ...
  val expectedCountriesList = List(
    ...
    Country("AQ", "title.british_antarctic_territory", "AQ", isEu=false, Nil),
    Country("IO", "title.british_indian_ocean_territory", "IO", isEu=false, List("BIOT")),
    Country("VG", "title.british_virgin_islands", "VG", isEu=false, Nil),
    ...
    Country("UM", "title.caroline_islands", "UM", isEu=false, Nil),
    ...
    Country("XC", "title.ceuta", "XC", isEu=false, Nil),
    ...
    Country("NI", "title.corn_islands", "NI", isEu=false, Nil),
    ...
    Country("GP", "title.desirade", "GP", isEu=true, Nil),
    ...
    Country("AE", "title.dubai", "AE", isEu=false, Nil),
    Country("TL", "title.e_east_timor", "TL", isEu=false, Nil),
    ...
    Country("AQ", "title.french_antarctic_territory", "AQ", isEu=true, Nil),
    ...
    Country("AE", "title.fujairah", "AE", isEu=false, Nil),
    Country("GA", "title.gabon", "GA", isEu=false, Nil),
    Country("GM", "title.gambia", "GM", isEu=false, Nil),
    Country("PS", "title.gaza_and_jericho", "PS", isEu=false, Nil),
    ...
    Country("SH", "title.gough", "SH", isEu=false, Nil),
    ...
    Country("US", "title.hawaii", "US", isEu=false, Nil),
    ...
    Country("UM", "title.howland_islands", "UM", isEu=false, Nil),
    Country("HU", "title.hungary", "HU", isEu=true, Nil),
    Country("IS", "title.iceland", "IS", isEu=false, Nil),
    Country("GP", "title.lles_des_saintes", "GP", isEu=false, Nil),
    ...
    Country("XK", "title.kosovo", "XK", isEu=false, Nil),
    ...
    Country("PT", "title.madeira", "PT", isEu=false, Nil),
    ...
    Country("IM", "title.man_of_isle", "IM", isEu=true, Nil),
    Country("GP", "title.maria_galante", "GP", isEu=true, Nil),
    ...
    Country("XL", "title.melilla", "XL", isEu=false, Nil),
    Country("MX", "title.mexico", "MX", isEu=false, Nil),
    Country("FM", "title.micronesia", "FM", isEu=false, Nil),
    Country("UM", "title.midway_island", "UM", isEu=false, Nil),
    Country("MD", "title.moldova", "MD", isEu=false, Nil),
    Country("FR", "title.monaco", "FR", isEu=true, Nil),
    ...
    Country("PS", "title.occupied_palestinian_territory", "PS", isEu=false, Nil),
    Country("OM", "title.oman", "OM", isEu=false, Nil),
    Country("PK", "title.pakistan", "PK", isEu=false, Nil),
    Country("UM", "title.palra_island", "UM", isEu=false, Nil),
    ...
    Country("BQ", "title.st_eustatius", "BQ", isEu=false, Nil),
    ...
    Country("GP", "title.st_maarten_north", "GP", isEu=false, Nil),
    Country("SX", "title.st_maarten_south", "SX", isEu=false, Nil),
    ...
    Country("ES", "title.spain", "ES", isEu=true, Nil),
    ...
    Country("NO", "title.svalbard_archipelago", "NO", isEu=false, Nil),
    Country("HN", "title.swan_islands", "HN", isEu=false, Nil),
    Country("SZ", "title.swaziland", "SZ", isEu=false, Nil),
    ...
    Country("SH", "title.tristan_da_cunha", "SH", isEu=false, Nil),
    ...
    Country("AE", "title.umm_al_qaiwain", "AE", isEu=false, Nil),
    ...
    Country("VA", "title.vatican_city", "VA", isEu=false, Nil),
    ...
    Country("UM", "title.wake_island", "UM", isEu=false, Nil),
