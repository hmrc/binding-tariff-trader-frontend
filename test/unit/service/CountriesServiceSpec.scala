...
class CountriesServiceSpec extends UnitSpec with MockitoSugar with GuiceOneAppPerSuite {
  ...
  val expectedCountriesList = List(
    ...
    Country("BQ", "title.bonaire", "BQ", isEu=false, Nil),
    ...
    Country("CC", "title.cocos_islands", "CC", isEu=false, Nil),
    ...
    Country("CG", "title.congo", "CG", isEu=false, List("Congo-Brazzaville", "Congo Republic")),
    ...
    Country("HM", "title.heard_and_mcdonald_islands", "HM", isEu=false, Nil),
    ...
    Country("IE", "title.irish_republic", "IE", isEu=true, List("Republic of Ireland", "Eire")),
    ...
    Country("SD", "title.north_sudan", "SD", isEu=false, Nil),
    Country("SR", "title.suriname", "SR", isEu=false, Nil),
    Country("SJ", "title.svalbard_archipelago", "SJ", isEu=false, Nil),
