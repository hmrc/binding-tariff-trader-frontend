...
class CountriesServiceSpec extends UnitSpec with MockitoSugar with GuiceOneAppPerSuite {
  ...
  val expectedCountriesList = List(
    ...
    Country("BR", "title.british_antarctic_territory", "AQ", isEu=false, Nil),
    Country("IO", "title.british_indian_ocean_territory", "IO", isEu=false, List("BIOT")),
    Country("IO", "title.british_virgin_islands", "VG", isEu=false, Nil),
    ...
    Country("CV", "title.caroline_islands", "UM", isEu=false, Nil),
    ...
    Country("TD", "title.ceuta", "XC", isEu=false, Nil),
    ...
    Country("CK", "title.corn_islands", "NI", isEu=false, Nil),
    ...
    Country("DK", "title.desirade", "GP", isEu=true, Nil),
    ...
    Country("DO", "title.dubai", "AE", isEu=false, Nil),
    Country("DO", "title.e_east_timor", "TL", isEu=false, Nil),
    ...
    Country("FR", "title.french_antarctic_territory", "AQ", isEu=true, Nil),
    ...
    Country("TF", "title.fujairah", "AE", isEu=false, Nil),
    Country("GA", "title.gabon", "GA", isEu=false, Nil),
    Country("GM", "title.gambia", "GM", isEu=false, Nil),
    Country("GM", "title.gaza_and_jericho", "PS", isEu=false, Nil),
    ...
    Country("GI", "title.gough", "SH", isEu=false, Nil),
    ...
    Country("HT", "title.hawaii", "US", isEu=false, Nil),
    ...
    Country("HK", "title.howland_islands", "UM", isEu=false, Nil),
    Country("HU", "title.hungary", "HU", isEu=true, Nil),
    Country("IS", "title.iceland", "IS", isEu=false, Nil),
    Country("IS", "title.lles_des_saintes", "GP", isEu=false, Nil),
    ...
    Country("KR", "title.kosovo", "XK", isEu=false, Nil),
    ...
    Country("MG", "title.madeira", "PT", isEu=false, Nil),
    ...
    Country("MT", "title.man_of_isle", "IM", isEu=true, Nil),
    Country("MT", "title.maria_galante", "GP", isEu=true, Nil),
    ...
    Country("YT", "title.melilla", "XL", isEu=false, Nil),
    Country("MX", "title.mexico", "MX", isEu=false, Nil),
    Country("FM", "title.micronesia", "FM", isEu=false, Nil),
    Country("FM", "title.midway_island", "UM", isEu=false, Nil),
    Country("MD", "title.moldova", "MD", isEu=false, Nil),
    Country("MC", "title.monaco", "FR", isEu=true, Nil),
    ...
    Country("OM", "title.occupied_palestinian_territory", "PS", isEu=false, Nil),
    Country("OM", "title.oman", "OM", isEu=false, Nil),
    Country("PK", "title.pakistan", "PK", isEu=false, Nil),
    Country("PK", "title.palra_island", "UM", isEu=false, Nil),
    ...
    Country("BL", "title.st_eustatius", "BQ", isEu=false, Nil),
