var fileList = (function () {
    ...
    var readableSize = function formatBytes(bytes, decimals) {
    ...
    var fileBoxDiv = function (name, size, errorMsg) {
        ...
        var output = '<div class="' + divClass + '" id="' + name + '">\n' +
            ...
            '    <div class="file-list__size">' + readableSize(size, 2) + '</div>\n' +
...
;(function (global) {
    ...
    global.uploadFileNameSpace = uploadControls;
